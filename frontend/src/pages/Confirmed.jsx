...
import { FaClipboardCheck, FaEye, FaSearch } from 'react-icons/fa';
import '../style/confirmed.css';
...
const Confirmed = () => {
  ...
  const fetchOrders = async () => {
    try {
      setLoading(true);
      const res  = await fetch('http://127.0.0.1:1000/api/orders-confirmed/');
      ...
      <div className="confirmed-page">
        ...
        <div className="orders-header">
          <div className="header-left">
            ...
            <div>
              ...
              <p>Orders confirmed and waiting to be prepared</p>
            </div>
          </div>
        ...
        {filtered.length === 0 ? (
          <div className="empty-orders">
            ...
            <p>There are no confirmed orders at the moment</p>
          </div>
        ) : (
          <div className="table-card">
            ...
            <div className="table-footer">
              <span>Showing <strong>{filtered.length}</strong> of <strong>{orders.length}</strong> confirmed orders</span>
